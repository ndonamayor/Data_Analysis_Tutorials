---
title: "Data analysis with R: 2-back hit RT"
output: 
  learnr::tutorial:
    progressive: TRUE
    allow_skip: TRUE
...
### Comparing the hit reaction times in the 2-back condition of patients and healthy controls
...
Specifically, you will compare the **average reaction times of hits in the 2-back condition** (X2backRTHitsmedian) in an N-back task of a group of psychiatric patients to those of a group of healthy controls. You will go through all necessary steps to end up with a meaningful output that you can report in a scientific way.
...
How do you think this will be reflected in the reaction times, if at all?
...
Obviously, in this module, we took care of experimental design and recruitment for you. Still, you chose to analyze the reaction times of hits in the 2-back condition in the patient vs. control sample, so you probably have some idea about why this could be interesting. Before you dive into data analysis, take a few minutes to consider what results you would expect, based on common sense and the clinical knowledge you acquired in this module.
...
my_data <- all_data %>% 
  select(group, subject, gender, age, RT = X2backRTHitsmedian) %>%
  drop_na(RT)
...
You are now ready to compare the reaction times of patients and controls in the 2-back condition. 
...
What conclusions can you draw from the results of your t-test about the working memory capacity of your groups?
...
That's it, you analyzed real 2-back data using a t-test!
